...
QWidget*
QArvCameraDelegate::createEditor(QWidget* parent,
...
void
QArvCameraDelegate::setEditorData(QWidget* editor,
                                  const QModelIndex& index) const
{
  auto var = index.model()->data(index, Qt::EditRole);
  if (!var.isValid()) {
...
void
QArvCameraDelegate::setModelData(QWidget* editor, QAbstractItemModel* model,
                                 const QModelIndex& index) const
{
...
void
QArvCameraDelegate::updateEditorGeometry(QWidget* editor,
...
void
QArvCameraDelegate::finishEditing()
{
...
QSize
QArvCameraDelegate::sizeHint(const QStyleOptionViewItem& option,
                             const QModelIndex& index) const
{
  if (!index.isValid())
