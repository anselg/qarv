...
QArvEditor::QArvEditor(QWidget* parent)
  : QWidget(parent)
{
...
QArvEditor*
QArvEnumeration::createEditor(QWidget* parent) const
{
...
void
QArvEnumeration::populateEditor(QWidget* editor) const
{
...
void
QArvEnumeration::readFromEditor(QWidget* editor)
{
  auto select = editor->findChild<QComboBox*>("selectEnum");
  if (!select) {
...
QArvEditor*
QArvString::createEditor(QWidget* parent) const
{
  auto editor = new QArvEditor(parent);
...
void
QArvString::populateEditor(QWidget* editor) const
{
...
void
QArvString::readFromEditor(QWidget* editor)
{
  auto edline = editor->findChild<QLineEdit*>("editString");
  if (!edline) {
...
QArvEditor*
QArvFloat::createEditor(QWidget* parent) const
{
  auto editor = new QArvEditor(parent);
...
void
QArvFloat::populateEditor(QWidget* editor) const
{
...
void
QArvFloat::readFromEditor(QWidget* editor)
{
  auto edbox = editor->findChild<QDoubleSpinBox*>("editFloat");
  if (!edbox) {
...
QArvEditor*
QArvInteger::createEditor(QWidget* parent) const
{
  auto editor = new QArvEditor(parent);
...
void
QArvInteger::populateEditor(QWidget* editor) const
{
...
void
QArvInteger::readFromEditor(QWidget* editor)
{
  auto edbox = editor->findChild<QSpinBox*>("editInteger");
  if (!edbox) {
...
{
  return value ? QObject::tr("on/true", "QArvCamera")
               : QObject::tr("off/false", "QArvCamera");
}

QArvEditor*
QArvBoolean::createEditor(QWidget* parent) const
{
  auto editor = new QArvEditor(parent);
...
void
QArvBoolean::populateEditor(QWidget* editor) const
{
...
void
QArvBoolean::readFromEditor(QWidget* editor)
{
  auto check = editor->findChild<QCheckBox*>("editBool");
  if (!check) {
...
QArvEditor*
QArvCommand::createEditor(QWidget* parent) const
{
  auto editor = new QArvEditor(parent);
...
void
QArvCommand::populateEditor(QWidget* editor) const
{
}

void
QArvCommand::readFromEditor(QWidget* editor)
{
}

QArvRegister::QArvRegister()
  : value()
{
}
...
QArvEditor*
QArvRegister::createEditor(QWidget* parent) const
{
  auto editor = new QArvEditor(parent);
  auto edline = new QLineEdit(editor);
...
void
QArvRegister::populateEditor(QWidget* editor) const
{
...
void
QArvRegister::readFromEditor(QWidget* editor)
{
  auto edline = editor->findChild<QLineEdit*>("editRegister");
  if (!edline) {
